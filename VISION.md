...
## Project Goal
To build an automated venue scouting and outreach pipeline for electronic music event curation. The system will automatically scrape/search the web to find local potential venues, find contact info, automatically reach out via email and/or phone, and attempt to persuade them to host events for a specific target genre (e.g., psytrance, techno).
